...
t.test(lizard_length_cnte, lizard_length_cnun)
...
#### Summary:
+ This analysis indicates CNTE (*Cnemidophorus tessalatus*, the Colorado Checkered lizard) had a larger mean (244.8929 ± 47.32499, *n* = 28; mean ± 1 standard deviation), compared to CNUN (*Cnemidophorus uniparens*, the Desert Grassland lizard) which had a smaller mean (147.6000 ± 34.55341, *n* = 47; mean ± 1 standard deviation). The acutal difference in means from CNTE and CNUN lizards is 97.2929. The outcome of the two sample t-test indicated there is not a strong change (*p* < 0.001) of randomly selecting two samples from populations with the same that are this difference by change. In sum, the difference in means is significant (Welch’s two-sample t-test: t(9.2834) = 46.434, *p* < 0.001), and the effect size is large (Cohen’s d = 2.41597).
